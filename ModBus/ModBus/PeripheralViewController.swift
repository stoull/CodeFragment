...
class PeripheralViewController: UIViewController {
    ...
    @IBAction func switchChanged(_ sender: Any) {
        ...
        if advertisingSwitch.isOn {
            peripheralManager.startAdvertising([CBAdvertisementDataLocalNameKey: "Hut_Battery_test", CBAdvertisementDataServiceUUIDsKey: [MGTransferService.serviceUUID]])
        } else {
            peripheralManager.stopAdvertising()
        }
    }
    ...
    private func setupPeripheral() {
        ...
        let transferCharacteristic = CBMutableCharacteristic(type: MGTransferService.characteristicUUID,
                                                         properties: [.notify, .write],
                                                         value: nil,
                                                         permissions: [.readable, .writeable])
        
        // Create a service from the characteristic.
        let transferService = CBMutableService(type: MGTransferService.serviceUUID, primary: true)
