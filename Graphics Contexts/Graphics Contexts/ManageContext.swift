...
class ManageContext: NSObject {
    
    var view: UIView = UIView.init(frame: UIScreen.main.bounds)
    ...
    /*
     ...
     CGContextSaveGState: Pushes a copy of the current graphics state onto the graphics state stack for the context.将当前的上下文状态保存到context的储存栈中。将上下文状态比作绘图软件的画布的话，上下文状态指其中画笔的颜色，大小，画的线条，还有‘坐标系统’啊，具体可见：
     https://developer.apple.com/documentation/coregraphics/1456156-cgcontextsavegstate
